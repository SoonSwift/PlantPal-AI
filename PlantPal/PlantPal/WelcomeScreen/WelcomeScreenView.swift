    ...
    @ObservedObject var viewModel: WelcomeScreenViewModel
         ...
         NavigationStack {
             MainStack {
                 VStack {
                     ...
                     PalText(text: "PlantPal AI", fontType: .regular, size: 32)
                         .padding(.bottom, 8)
                     
                     PalText(text: "Your pocket botanist", fontType: .regular, size: 18)
                         .padding(.bottom, 4)
     ...
     private func buildInputView() -> some View {
         VStack(alignment: .leading) {
             ...
             PalText(text: "OpenAI Api key", fontType: .regular, size: 12)
             ...
             if viewModel.isApiKeyValid == false {
                 PalText(text: "Key is invalid", fontType: .regular, size: 12)
                     .padding(.horizontal, 8)
                     .foregroundColor(.red)
             }
         }
